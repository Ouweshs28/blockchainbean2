...
class MyContract extends Contract {
  ...
  async approveCertificate(ctx, regulator, applicationId, regulatorComments, timestamp) {
    ...
    if(certificateApproval.clinicalLaboratory.certificateState == 'PASSED_QUALITY_CHECK'){
      certificateApproval.clinicalLaboratory.certificateState == 'READY_FOR_DISTRIBUTION'
